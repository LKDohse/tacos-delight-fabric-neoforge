...
public class CheesePressBlockEntityNeoForge extends BlockEntity implements GeoBlockEntity, GeoAnimatable {
    protected final PropertyDelegate propertyDelegate;
    private int progress = 0;
    private int maxProgress = 12000;
    protected boolean pressing;

    public CheesePressBlockEntityNeoForge(BlockPos pos, BlockState state) {
        super(NeoForgeModBlockEntities.CHEESE_PRESS_BE.get(), pos, state);

        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> CheesePressBlockEntityNeoForge.this.progress;
                    case 1 -> CheesePressBlockEntityNeoForge.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0:
                        CheesePressBlockEntityNeoForge.this.progress = value;
                    case 1:
                        CheesePressBlockEntityNeoForge.this.maxProgress = value;
                }
            }
