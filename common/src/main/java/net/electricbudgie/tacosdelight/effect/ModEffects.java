...
public class ModEffects {
    ...
    public static final RegistrySupplier<StatusEffect> DISAPPOINTED = EFFECTS.register("disappointed",
    ...
    public static final RegistrySupplier<StatusEffect> GAS_CLOUD_DAMAGE = EFFECTS.register("gas_cloud_damage",
            () -> new GasCloudDamageEffect(StatusEffectCategory.HARMFUL, 0x7d5011));

    public static final RegistrySupplier<StatusEffect> GASSY = EFFECTS.register("gassy",
            () -> new GassyEffect(StatusEffectCategory.HARMFUL, 0x7d5011));

    public static final RegistrySupplier<StatusEffect> SPICY = EFFECTS.register("spicy",
    ...
    public static RegistryEntry<StatusEffect> getDisappointedEntry(World world) {
        return world.getRegistryManager()
                .get(RegistryKeys.STATUS_EFFECT)
                .getEntry(DISAPPOINTED.get());
    }
}