package net.electricbudgie.fabric.tacosdelight.screen.custom;
...
public class DeepFryerScreenHandler extends ScreenHandler {
    ...
    public final DeepFryerBlockEntityFabric blockEntity;
    ...
    public DeepFryerScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate){
        super(FabricModScreenHandlers.DEEP_FRYER_HANDLER, syncId);
        checkSize((Inventory)blockEntity, 2);
        this.inventory = (Inventory)blockEntity;
        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity = (DeepFryerBlockEntityFabric)blockEntity;
