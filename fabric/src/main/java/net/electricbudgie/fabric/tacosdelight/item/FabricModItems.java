...
public class FabricModItems {
    ...
    //Block Items
    public static final RegistrySupplier<Item> CHEESE_PRESS_ITEM = registerItemSupplier("cheese_press", ()-> new BlockItem(FabricModBlocks.CHEESE_PRESS_BLOCK.get(), new Item.Settings()));
    public static final RegistrySupplier<Item> DEEP_FRYER_ITEM = registerItemSupplier("deep_fryer", ()-> new BlockItem(FabricModBlocks.DEEP_FRYER_BLOCK.get(), new Item.Settings()));
